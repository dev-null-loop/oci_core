variable "asn" {
  description = "(Required) The Autonomous System Number (ASN) you are importing to the Oracle cloud."
  type        = string
}

variable "compartment_id" {
  description = "(Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the BYOASN Resource."
  type        = string
}
